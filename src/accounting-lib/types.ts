...
/**
 * สีประจำประเภทเอกสาร — แถบมุมขวาบน หัวข้อ และเส้นคาดตาราง
 *
 * เอกสารที่พิมพ์คงสีไว้ตามเดิม แม้หน้าจอระบบจะเป็นธีมขาวดำแล้ว
 * เพราะกระดาษที่ส่งลูกค้าคนละบริบทกับหน้าจอที่ทีมใช้ทำงาน —
 * ในกองเอกสารบนโต๊ะ สีมุมกระดาษช่วยหยิบใบที่ต้องการได้เร็วกว่าอ่านหัวเรื่อง
 */
