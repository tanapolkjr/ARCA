...
### 52.3 เอกสารที่พิมพ์เป็นขาวดำด้วย

- **`DOC_COLOR` เป็นดำทั้งหมด** เดิมแยกสีตามประเภทแบบ FlowAccount (ส้ม/ม่วง/ฟ้า)
  แต่ตราบริษัทเป็นขาวดำ เอกสารสีเลยไม่เข้าชุด และการแยกประเภทด้วยสีก็ซ้ำซ้อน
  เพราะชื่อเอกสารตัวใหญ่บอกชัดกว่าอยู่แล้ว — ผลพลอยได้คือพิมพ์ขาวดำได้เต็มคุณภาพ
- **มุมกระดาษเปลี่ยนจากสามเหลี่ยมทึบ 26mm เป็นเส้นบาง** สะอาดกว่าและประหยัดหมึกมาก

> ถ้าอยากได้สีแยกประเภทกลับมา แก้ที่ `DOC_COLOR` ใน `accounting-lib/types.ts` ที่เดียว
