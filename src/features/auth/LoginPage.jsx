    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex items-center justify-center px-4 font-sans">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-stone-800 rounded-2xl border border-stone-200 dark:border-stone-700 shadow-sm p-7">
          <h1 className="text-lg font-bold text-stone-900 mb-1">เข้าสู่ระบบ</h1>
          <p className="text-sm text-stone-400 mb-6">E-Service Backend System</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-sm font-medium text-stone-600 mb-1.5">อีเมล</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-stone-200 text-sm bg-stone-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-stone-900"
                />
              </div>
            </div>
            <div className="mb-6">
              <label className="block text-sm font-medium text-stone-600 mb-1.5">รหัสผ่าน</label>
              <div className="relative">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-2.5 rounded-xl text-sm font-medium text-white bg-stone-900 hover:bg-stone-800 dark:bg-stone-100 dark:text-stone-900 dark:hover:bg-white shadow-sm disabled:opacity-60"
            >
