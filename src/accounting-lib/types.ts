...
/**
 * สีบนเอกสารที่พิมพ์ — ธีมขาวดำใช้หมึกดำทั้งหมด
 *
 * เดิมแยกสีตามประเภท (ส้ม/ม่วง/ฟ้า) แบบ FlowAccount แต่ตราบริษัทเป็นขาวดำ
 * เอกสารสีเลยดูไม่เข้าชุดกัน และการแยกประเภทด้วยสีก็ซ้ำซ้อนอยู่แล้ว
 * เพราะชื่อเอกสารตัวใหญ่บอกชัดกว่า (ใบเสนอราคา / ใบแจ้งหนี้ / ใบกำกับภาษี)
 *
 * ผลพลอยได้: พิมพ์ขาวดำได้เต็มคุณภาพ และประหยัดหมึกสี
 */
export const DOC_COLOR: Record<string, string> = {
  QT: '#0f172a', BL: '#0f172a', INV: '#0f172a', RC: '#0f172a',
  CN: '#0f172a', DN: '#0f172a', PO: '#0f172a', PI: '#0f172a',
  PV: '#0f172a', IM: '#0f172a',
};
